...
const removeStore = async (req, res) => {
    const { error: validationError, value: queryParams } = (0, requestHandler_1.validateRequest)(storeSchema_1.deleteStoreSchema, req.params);
    if (validationError)
    ...
    try {
        ...
        logs_1.default.info('Store deleted successfully');
