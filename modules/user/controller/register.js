...
const registerUser = async (req, res) => {
    const { error: validationError, value: validatedData } = (0, requestHandler_1.validateRequest)(user_1.userRegistrationSchema, req.body);
    if (validationError)
    ...
    try {
        ...
        if (existingUser != null) {
            const message = `E-mail ${existingUser.email} is already registered. Please use another one.`;
