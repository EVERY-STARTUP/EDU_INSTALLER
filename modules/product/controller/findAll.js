...
const findAllProduct = async (req, res) => {
    const { error: validationError, value: queryParams } = (0, requestHandler_1.validateRequest)(productSchema_1.findAllProductSchema, req.query);
    if (validationError)
    ...
    try {
        ...
        logs_1.default.info('Platforms retrieved successfully');
